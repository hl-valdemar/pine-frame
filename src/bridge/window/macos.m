...
// //   if (!window || !window->current_command_buffer ||
// //   !window->current_drawable) {
// //     return;
// //   }
// //
// //   @autoreleasepool {
// //     // present drawable, commit command buffer, and wait for completion
// //     [window->current_command_buffer
// //     presentDrawable:window->current_drawable];
...
- (void)windowDidResize:(NSNotification *)notification {
  ...
  // We could add a resize event here if needed
}
